...
export const PokemonDetails: React.FC = () => {
  ...
  useEffect(() => {
    if (selectedPokemon) setFavorite(getIfPokemonFavorite(selectedPokemon.id));
  }, [selectedPokemon]);
                    ...
                    <ScrollPanel style={{ width: "100%", height: "100%" }}>
                      <article className="px-3">
                        ...
                        <section className="inline-grid w-full grid-cols-12 flex-col gap-y-1 font-semibold">
                          ...
                          <h2 className="col-span-9">{`${getWeightInHectograms(selectedPokemon.weight)} (${selectedPokemon.weight / 10}kg)`}</h2>
                        ...
                        <h1 className="mb-2 mt-3 text-xl font-bold">
                          Breeding
                        </h1>
                    ...
                    <ScrollPanel style={{ width: "100%", height: "100%" }}>
                      <article className="px-3">
                        <section className="inline-grid w-full grid-cols-12 flex-col gap-y-1 font-semibold">
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[0]
                                .base_stat
                            }
                            text="HP"
                            total_stats={false}
                          ...
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[1]
                                .base_stat
                            }
                            text="Attack"
                            total_stats={false}
                          ...
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[2]
                                .base_stat
                            }
                            text="Defense"
                            total_stats={false}
                          ...
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[3]
                                .base_stat
                            }
                            text="Sp. Attack"
                            total_stats={false}
                          ...
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[4]
                                .base_stat
                            }
                            text="Sp. Defense"
                            total_stats={false}
                          ...
                          <PokemonStatBar
                            base_stat={
                              selectedPokemon.pokemon_v2_pokemonstats[5]
                                .base_stat
                            }
                            text="Speed"
                            total_stats={false}
                            ...
                            .map((_theme, index) => (
                              ...
                              >
                                ...
                                {getEffectivenessAgainstType(
                                  ...
                                  selectedPokemon.pokemon_v2_pokemontypes[0]
                                    .type_id - 1,
                                  selectedPokemon.pokemon_v2_pokemontypes
                                    .length == 1
                                    ? -1
